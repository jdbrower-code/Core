...
int main(int, char**)
{
    ...
    bool ret = LoadTextureFromFile("E:\Libraries\imgui\examples\Textures\MyImage01.jpg", g_pd3dDevice, my_texture_srv_cpu_handle, &my_texture, &my_image_width, &my_image_height);
    IM_ASSERT(ret);
...
bool CreateDeviceD3D(HWND hWnd)
{
...

    {
        ...
        //desc.Type = D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV;     //adjustment for image load
        desc.Type = D3D12_DESCRIPTOR_HEAP_TYPE_RTV;           //Original ImGui Code
        ...
        desc.NumDescriptors = NUM_BACK_BUFFERS;               //Original ImGui Code
        //desc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE; //adjustment for image load
        desc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_NONE;         //Original ImGui Code  
        desc.NodeMask = 1;                                    //Original ImGui Code
